#!/usr/bin/env python3
"""Unnamed Strategy — Auto-Patch v4. Fixes the last UI pattern."""
...
def main():
    parser = argparse.ArgumentParser(description="Apply Unnamed Strategy patches v4")
