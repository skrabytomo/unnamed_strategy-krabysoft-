...
static const std::vector<int> kBuildOrder[9] = {
    ...
    { CW_HALL, CW_T1, CW_T1_A, MARKET, CW_T2, CW_T2_A, FORT, CW_WARDEN_BRAND, CW_T3, CW_T3_A,
      TOWN_HALL, CW_DEATH_ALTAR, CW_T4, CW_T4_A, CITY_HALL, CW_T5, CW_T5_A, CW_T6, CW_T6_A },
    { TK_GROVE_HEART, TK_T1, TK_T1_A, TK_SYMBIOSIS_WEB, MARKET, TK_T2, TK_T2_A,
      TK_ANCIENT_CIRCLE, FORT, TK_T3, TK_T3_A, TOWN_HALL, TK_T4, TK_T4_A,
      CITY_HALL, TK_T5, TK_T5_A, TK_T6, TK_T6_A },
    { EE_THRONE, EE_T1, EE_T1_A, EE_NECROPOLIS, FORT, EE_T2, EE_T2_A, MARKET, EE_MONUMENT,
      EE_T3, EE_T3_A, TOWN_HALL, EE_T4, EE_T4_A, MAGE_GUILD, CITY_HALL,
      EE_T5, EE_T5_A, EE_T6, EE_T6_A },
    { BS_WAR_HALL, BS_T1, BS_T1_A, BS_T2, BS_T2_A, FORT, MARKET, BS_T3, BS_T3_A,
      ...
      BS_T5, BS_T5_A, BS_T6, BS_T6_A },
    { VK_NEXUS, MARKET, VK_T1, VK_T1_A, MAGE_GUILD, VK_T2, VK_T2_A, FORT, VK_RIFT_GATE,
      VK_T3, VK_T3_A, TOWN_HALL, VK_VOID_LENS, VK_T4, VK_T4_A, CITY_HALL,
      VK_T5, VK_T5_A, VK_T6, VK_T6_A },
    { IA_FORGE_HALL, FORT, IA_T1, IA_T1_A, IA_BLUEPRINT_VAULT, MARKET, IA_T2, IA_T2_A,
      ...
      CITY_HALL, IA_T5, IA_T5_A, IA_T6, IA_T6_A },
    { AM_GRAFTING_HALL, AM_T1, AM_T1_A, MARKET, AM_T2, AM_T2_A, FORT, AM_MERGE_CHAMBER,
      ...
      AM_T5, AM_T5_A, AM_T6, AM_T6_A },
    { CV_SYNTHESIS_HUB, CV_T1, CV_T1_A, MARKET, CV_T2, CV_T2_A, FORT, MAGE_GUILD,
      CV_T3, CV_T3_A, TOWN_HALL, CV_T4, CV_T4_A, CV_RESONANCE_WELL, CITY_HALL,
      CV_T5, CV_T5_A, CV_MIRROR_CHAMBER, CV_T6, CV_T6_A },
};
...
// Run all movement for one AI hero for its turn (score-based + optional MCTS goal selection).
                        ...
                        int mctsRolloutWeeks = 3)
{
    ...
    while (hero.movePool > 0) {
        ...
        if (useMCTS) {
            ...
            mctsParams.simulations  = mctsSimulations;
            mctsParams.rolloutWeeks = mctsRolloutWeeks;
            mctsParams.seed         = static_cast<int>(hero.pos.q * 997 + hero.pos.r * 31 + hero.movePool);

            goal = MCTSHero::selectGoal(topPositions, snap, map, udefs, breg, reg, mctsParams);
        } else {
            goal = topPositions[0]; // pure score-based, fast
        }
    ...
    for (week = 1; week <= cfg.maxWeeks && p1Alive && p2Alive; ++week) {
        ...
        for (int d = 0; d < 7 && p1Alive && p2Alive; ++d) {
            ...
            aiHeroTurn(h1, h2, towns, resnodes, objects, map, udefs, classReg, reg, false,
                       cfg.useMCTS, cfg.mctsSimulations, cfg.mctsRolloutWeeks);
