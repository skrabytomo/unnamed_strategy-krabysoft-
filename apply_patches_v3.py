#!/usr/bin/env python3
"""Unnamed Strategy — Auto-Patch v3. Broader patterns for 4 remaining fixes."""
...
PATCHES = [
    # --- Already working from v2 (keep them) ---
    {
...
"""
    },
    {
        ...
        "search": r'm_watchAiAutoExit\s*&&\s*m_watchingAI',
        "insert_after": True,
        "code": """
...
"""
    ...
    # --- v3: Broader patterns for the 4 that failed ---
    {
        "name": "AI Early Game Buildup (broad)",
        "file": "src/core/Game_WorldMap.cpp",
        "search": r"aiTakeHeroTurn\s*\(\s*int",
        "insert_after": True,
        "code": """
...
"""
    ...
    {
        "name": "Boat Texture Loading (broad)",
        "file": "src/core/Game_Core.cpp",
        "search": r'm_heroTex\[.*\]\.load\s*\(',
        "insert_after": True,
        "code": """
...
"""
    ...
    {
        "name": "UI Null Guard (broad)",
        "file": "src/core/Game_WorldMap.cpp",
        "search": r"ImGui::Begin\(\s*\".*Info.*\"",
        "insert_after": True,
        "code": """
...
def main():
    parser = argparse.ArgumentParser(description="Apply Unnamed Strategy patches v3")
