...
execute_process(
  COMMAND "C:/msys64/ucrt64/bin/git.exe" --git-dir=.git show-ref "v1.90.8"
  WORKING_DIRECTORY "C:/msys64/home/skraby/FIT/game/build/_deps/imgui-src"
...
if(git_update_strategy STREQUAL "CHECKOUT")
  ...
  if(error_code)
    ...
    if(NOT git_update_strategy STREQUAL "REBASE_CHECKOUT")
      ...
      message(FATAL_ERROR "\nFailed to rebase in: 'C:/msys64/home/skraby/FIT/game/build/_deps/imgui-src'."
...
if(need_stash)
  ...
  if(error_code)
    ...
    if(error_code)
      ...
      message(FATAL_ERROR "\nFailed to unstash changes in: 'C:/msys64/home/skraby/FIT/game/build/_deps/imgui-src'."
                          "\nYou will have to resolve the conflicts manually")
    endif()
  endif()
endif()
